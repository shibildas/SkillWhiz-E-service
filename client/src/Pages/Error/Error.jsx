    ...
    <>
      <div className="text-white text-center bg-gradient-to-r from-orange-300 to-sky-300 h-[100vh] flex justify-center ">
        <div className="m-56">
          ...
          <h1 className="p-2 text-center text-zinc-700 font-mono font-extrabold text-7xl">
            OOPs...:404 error
          </h1>
          <h1 className="p-2 text-center text-zinc-700 font-mono font-extrabold text-5xl">
