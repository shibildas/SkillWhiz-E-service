                ...
                ? filteredDatas?.map((data, index) => {
                    return (
                      ...
                      >
                          ...
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              <div className="font-bold">
                                {data?.jobId?.job_role?.toUpperCase()}
                              </div>
                        ...
                        <td className=" font-bold">{data?.slot}</td>
                        <th>
                          {new Date(data?.booking_date)?.toLocaleString(
                            "en-US",
                            {
                              timeZone: "UTC",
                            }
                        ...
                        <th>
                          <Link to={`/admin/bookings/${data?._id}`}>
                            <label
                              className="underline font-bold text-gray-800 cursor-pointer"
                              htmlFor=""
                            >
                              View Detail
                            </label>
