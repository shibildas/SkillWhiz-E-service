...
export const baseUrl = "https://skillwhiz-api.drtyre.co";
export const expertBaseUrl = "https://skillwhiz-api.drtyre.co/expert/";
export const AdminBaseUrl = "https://skillwhiz-api.drtyre.co/admin/";
export const footerImg = [
  ...
  {
    img: "https://res.cloudinary.com/dpfnxwvps/image/upload/v1680611439/asset_65_xgpq65.webp",
    val: "VERIFIED PARTNERS",
  },
  {
    img: "https://res.cloudinary.com/dpfnxwvps/image/upload/v1680611439/asset_64_kgdfeu.webp",
    val: "SERVICE WARRANTY",
  },
  {
    img: "https://res.cloudinary.com/dpfnxwvps/image/upload/v1680611439/asset_66_kteyb8.webp",
    val: "TRANSPARENT PRICING",
  },
  {
    img: "https://res.cloudinary.com/dpfnxwvps/image/upload/v1680611439/asset_67_p4sy3z.webp",
    val: "ONLINE PAYMENTS",
  },
  {
    img: "https://res.cloudinary.com/dpfnxwvps/image/upload/v1680611439/asset_68_idgmtx.webp",
    val: "SUPPORT",
  },
];
export const footerRay = [
  "About us",
  "Terms & Conditions",
  "Privacy Policy",
  "Cancellation Policy",
...
export const comment =
  "SkillWhiz connects you to experts around you for Home Maintenance and Repairs, Utility, Lifestyle, Health, Beauty, Travel, and other local services, and also brings Local Shopping, Deals, and Events to you, right where you are, through an easy to use platform. Schedule services as per your convenience, pay online or by cash, get warranty on services, and avail cashbacks and discounts through our rewards program. Uncomplicate Life!";
export const icon =
  "https://res.cloudinary.com/dpfnxwvps/image/upload/c_crop,w_381/v1680611257/crystal-removebg-preview_fafyxj.avif";
export const social = [
  "https://res.cloudinary.com/dpfnxwvps/image/upload/v1680611258/instagram_lhi2p5.svg",
  "https://res.cloudinary.com/dpfnxwvps/image/upload/v1680611258/google_o9snal.svg",
  "https://res.cloudinary.com/dpfnxwvps/image/upload/v1680611258/linkedin_fqdmx6.svg",
  "https://res.cloudinary.com/dpfnxwvps/image/upload/v1680611257/facebook_yyjr7u.svg",
];
