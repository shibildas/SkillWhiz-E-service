...
const Footer = ()=>{
    return(
        ...
        <div className="vw-100 h-full bg-slate-300">
            <h1 className="p-4 text-6xl font-bold">Why Skillwhiz ?</h1>
            ...
            <ul className="p-4 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-7 gap-4">
                {footerRay.map((ele,index)=>{
                    return <li key={10+index} className="p-2 flex flex-col justify-center items-center">{ele}</li>
                })}
            </ul>
            <ul className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-64 p-5">
