...
const Reason = ({ id, handleLoad }) => {
  ...
  const handleReject = () => {
    if (reason === "") {
      ...
      rejectExpert(id, reason).then((res) => {
          ...
          <div className="flex justify-center my-2">
            <div>
              ...
              <textarea
                ...
                value={reason}
                className=" textarea my-2 textarea-bordered textarea-error textarea-lg w-full text-black max-w-xs"
                onChange={(e) => {
