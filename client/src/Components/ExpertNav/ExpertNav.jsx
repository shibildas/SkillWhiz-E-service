...
const navigate=useNavigate()
  ...
  <div className="navbar-start">
    ...
    <Link to="/expert/home" className="px-2 cursor-pointer"><img className="w-10 md:w-14 rounded-full sxhadow-2xl" src={logo} alt="logo" /></Link>
  </div>
  <div className="navbar-center hidden lg:flex text-white text-xl font-bold">
    <ul className="menu menu-horizontal px-1">
      ...
      <li className="hover:scale-105 transition duration-300" tabIndex={0}>
       ...
       {data?.verified && <li><Link to='/expert/chat'>Chat</Link></li>}
  ...
  <div className="dropdown dropdown-end">
      <label tabIndex={0} className="btn btn-sm md:btn-md btn-ghost btn-circle avatar">
